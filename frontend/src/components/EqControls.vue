      ...
      >
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-2">
            ...
            <small :class="{ 'text-red-500': savePresetForm.name.length >= 50 }"
              >{{ savePresetForm.name.length }}/50 characters</small
            >
          </div>
          <div class="flex flex-col gap-2">
          ...
          <div class="flex flex-col gap-2">
            ...
            <Select
              id="preset-category"
              v-model="savePresetForm.preset_category_id"
      ...
      >
        <div class="flex flex-col gap-6">
          ...
          <FileUpload
            ...
            :maxFileSize="1000000"
            :auto="true"
            chooseLabel="Choose Preset File"
            class="mb-4"
            @select="onFileSelect"
            :customUpload="true"
          >
