...
<template>
  <div
    class="fixed w-full z-50 transition-all duration-400 ease-in-out pb-5"
    :class="{
      'lg:top-3': isScrolled,
      'top-0': !isScrolled,
    }"
  >
    <Menubar
      :model="items"
      class="transition-all duration-400 ease-in-out mx-auto"
      :class="{
        ...
        <router-link v-if="item.route" v-slot="{ href, navigate }" :to="item.route" custom>
          ...
          >
            ...
            <i
              ...
              class="pi pi-lock ml-auto text-yellow-500"
              v-tooltip.bottom="'Login required'"
            ></i>
          </a>
        </router-link>
