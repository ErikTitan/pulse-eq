    ...
    return {
      ...
      frequencyRegions: [
        ...
        },
        {
          ...
          maxFreq: 1000,
          description:
            'Lower Midrange contains the fundamental frequencies of most instruments and vocals, providing warmth and body to music. This region is crucial for the natural sound of male vocals, guitars, and many acoustic instruments. Too much emphasis here can make music sound boxy or congested, while too little can make it sound thin and lacking in substance. Proper balance in this region is essential for musical coherence.',
        },
        {
          id: 'upper-mid',
          name: 'Upper Midrange',
          ...
          maxFreq: 4000,
          description:
            'Upper Midrange is critical for speech intelligibility and musical clarity. This region contains the harmonics that help distinguish between different instruments and make vocals cut through a mix. It\'s where the "presence" of most sounds lives. However, this region can become fatiguing if overemphasized, leading to harsh or aggressive sound. Proper control here is essential for long listening sessions without fatigue.',
        },
        {
          id: 'presence',
        ...
        },
        {
          ...
          maxFreq: 10000,
          description:
            'Mid Treble adds sparkle and detail to music, enhancing the perception of clarity and openness. This region contains important harmonics for cymbals, string instruments, and vocal consonants. It can make music sound more detailed and "hi-fi" when properly balanced. However, excessive mid treble can lead to sibilance in vocals and make cymbals sound harsh or metallic. This region requires careful tuning for optimal musical enjoyment.',
        },
        {
          id: 'air',
          name: 'Air',
