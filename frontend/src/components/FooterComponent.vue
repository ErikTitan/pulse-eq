    ...
    return {
      links: {
        ...
        resources: [
          {
            label: 'Documentation',
            url: 'https://github.com/ErikTitan/web-eq/blob/main/README.md',
          },
  ...
  <footer class="mt-auto px-6 lg:px-20 mb-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
      ...
      <div class="col-span-1">
        <div class="flex items-center gap-3 mb-2 group">
          ...
          <span class="text-2xl"> Pulse-EQ </span>
        </div>
        <p class="text-md leading-relaxed mb-3">
          Transform your audio experience with professional-grade equalization tools right in your
          browser.
        </p>
      </div>
      ...
      <div v-for="(section, key) in links" :key="key" class="col-span-1">
        ...
        <ul class="space-y-3">
          <li
            ...
            :key="link.label"
            class="transform transition-all hover:translate-x-2"
          >
    ...
    <div class="mt-6 border-t border-gray-200">
      <div class="flex flex-col mt-6 md:flex-row justify-between items-end">
        <div class="text-sm text-gray-500">© 2025 Pulse-EQ. All rights reserved.</div>
