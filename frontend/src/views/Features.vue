    ...
    return {
      ...
      features: [
        ...
        },
        {
          ...
          description: 'Visualize your audio adjustments with real-time frequency response graphs.',
        },
      ],
    }
  },
...
<template>
  <div class="min-h-screen bg-gradient-to-b from-surface-ground to-white py-12 px-4">
    ...
    <div class="max-w-6xl mx-auto text-center mb-16 mt-16">
      <h1 class="text-5xl font-bold mb-6">Transform Your Audio Experience</h1>
      ...
      <div class="equalizer-demo mt-8">
        <div class="flex justify-center gap-2">
          <div
            ...
            @mouseover="activateBand(index)"
            @mouseout="resetBand(index)"
          >
